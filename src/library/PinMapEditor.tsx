 ...
 *
 * 여기 격자는 **부품 정의 기준**(회전 전)이다. 이 화면에는 방향이 없다 — 방향은
 * 도면에 놓인 커넥터의 성질이지 부품의 성질이 아니기 때문이다. 캔버스는 이 정의를
 * 그대로 두고 **그릴 때만** 방향에 맞춰 세운다(canvas/geometry.ts 의 drawGrid).
 * 그래서 같은 부품을 네 방향으로 놓아도 여기 정의는 흔들리지 않는다.
 *
